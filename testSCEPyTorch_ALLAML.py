...
def runSCE(trData, trLabels, l1Penalty, lrnRate, num_epochs_pre, num_epochs_post, standardizeFlag, preTrFlag):
    ...
    while not(flag):
        ...
        # initiate an object of the model and call its training method 
        ...
        model.fit(trData, trLabels, preTrFlag, optimizationFunc='Adam', learningRate=lrnRate, m=momentum, miniBatchSize=miniBatch_size,
